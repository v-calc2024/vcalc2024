...
export default function MyNGO({ decoded, lang }: any) {
  const {
    handleSubmit,
    setFile,
    file,
  ...
  let hour_wage_input_tooltip = "Country minimum wage (€)";
  ...
  let accept_btn = "Update a NGO account";
  ...
  switch (lang) {
    case "es":
      ...
      hour_wage_input = "Salario por hora";
      ...
      accept_btn = "Actualizar una cuenta de ONG";
    ...
    case "fr":
      ...
      hour_wage_input_tooltip = "Salaire minimum du pays (€)";
      country_input = "* Pays";
      country_input_tooltip =
      ...
      accept_btn = "Mettre à jour un compte d'ONG";
    ...
    case "hr":
      ...
      hour_wage_input_tooltip = "Minimalna plaća u zemlji (€)";
      ...
      accept_btn = "Ažurirajte račun NVO-a";
    ...
    case "sq":
      ...
      hour_wage_input_tooltip = "Paga minimale e vendit (€)";
      country_input = "* Vendi";
      country_input_tooltip =
      ...
      accept_btn = "Përditësoni një llogari të OJQ-së";
    ...
    default:
      ...
      hour_wage_input_tooltip = "Country minimum wage (€)";
      ...
      accept_btn = "Update a NGO account";
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form">
            ...
            <div className="row">
              <InputText
                label={email_input}
                validation={(e: any) => validateUpdateONGEmail(e, lang)}
                required={true}
                name="email"
...
export const getServerSideProps: any = async (context: any) => {
  ...
  return { props: { decoded: decoded, lang: context.query.lang } };
};
