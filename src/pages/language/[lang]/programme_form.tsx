...
export default function ProgrammeRegistration({ type, lang }: any) {
  const {
    handleSubmit,
    changeName,
    name,
  ...
  let costProgDelivery_input = "Cost of Programme Delivery";
  let costProgDelivery_input_tooltip =
    "Please indicate approximately how much the delivery of the programme costs?";
  ...
  switch (lang) {
    case "es":
      ...
      costProgDelivery_input = "Costo de la entrega del programa";
      costProgDelivery_input_tooltip =
        "¿Por favor indique aproximadamente cuánto cuesta la entrega del programa?";
      break;
    case "fr":
      ...
      costProgDelivery_input = "Coût de la prestation du programme";
      costProgDelivery_input_tooltip =
        "Veuillez indiquer approximativement combien coûte la prestation du programme?";
      break;
    case "hr":
      ...
      costProgDelivery_input = "Trošak isporuke programa";
      costProgDelivery_input_tooltip =
        "Navedite koliko otprilike košta dostava programa?";
      break;
    case "sq":
      ...
      costProgDelivery_input = "Kostoja e dorëzimit të programit";
      costProgDelivery_input_tooltip =
        "Ju lutemi tregoni përafërsisht sa kushton shpërndarja e programit?";
      break;
    default:
      ...
      costProgDelivery_input = "Cost of Programme Delivery";
      costProgDelivery_input_tooltip =
        "Please indicate approximately how much the delivery of the programme costs?";
      break;
  }
        ...
        <form onSubmit={handleSubmit}>
          <div className="form">
            ...
            <InputText
              ...
              clearError={() => {}}
              withTooltip={true}
              tooltip={costProgDelivery_input_tooltip}
              tooltipTop="-4rem"
            />
          </div>
          {errors?.length > 0 && (
