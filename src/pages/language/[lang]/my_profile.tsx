...
export default function MyProfile({ decoded, lang }: any) {
  const {
    handleSubmit,
    setFile,
    file,
  ...
  let submit_button_text = "Update my account";
  ...
  switch (lang) {
    case "es":
      ...
      name_input = "Nombres";
      name_input_tooltip = "Por favor proporcione sus nombres";
      ...
      submit_button_text = "Actualizar mi cuenta";
    ...
    case "fr":
      ...
      submit_button_text = "Mettre à jour mon compte";
    ...
    case "hr":
      ...
      submit_button_text = "Ažuriraj moj račun";
    ...
    case "sq":
      ...
      submit_button_text = "Përditëso llogarinë time";
  ...
  activities. Please identify if you have a disability or select 'prefer not to say' in case you do not want to share`;
      ...
      submit_button_text = "Update my account";
  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form">
            ...
            <div className="row">
              <InputText
                label={email_input}
                validation={(e: any) => validateUpdateVolunteerEmail(e, lang)}
                required={true}
                name="email"
      ...
      >
        <React.Fragment>
          <DeleteVol handleClose={handleClose} decoded={decoded} lang={lang} />
        </React.Fragment>
      </Modal>
      <style jsx>{`
        main {
...
export const getServerSideProps: any = async (context: any) => {
  ...
  return { props: { decoded, lang: context.query.lang } };
};
