...
export default function NGORegistration() {
  ...
  async function validateEmail(name: string) {
    const emailError = await validateOngEmail(name);
    return emailError;
  }
      ...
      <main>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="buttonCont">
            ...
            >
              {loading ? <ButtonLoader /> : "Create a NGO account"}
            </Button>
          </div>
        </form>
      </main>
