  ...
  return (
    <>
      ...
      <main>
        ...
        <PieChartGapComponent data={volByTwoOrMoreOrgAct.sort(orderByName)} />
        ...
        <div className="table-5">
          ...
          <div>
            {report?.volProgrammeByTypes?.secondMonth?.map((report: any) => {
              return (
                <div key={report?.label}>{report?.volArr?.length || 0}</div>
              );
            })}
                ...
                return (
                  <div key={volProgByTypes?.label}>
                    {(volProgByTypes?.volArr?.length || 0) +
                      (report?.volProgrammeByTypes?.secondMonth[index]?.volArr
                        ?.length || 0) +
                      (report?.volProgrammeByTypes?.thirdMonth[index]?.volArr
                        ?.length || 0)}
                  </div>
                );
              }
        ...
        <div className="table-5">
          ...
          <div className="column-title">accumulated</div>
          <div>
            {report?.volProgrammeBySector?.firstMonth?.map((report: any) => {
              return <div key={report?.label}>{report?.label}</div>;
            })}
          </div>
          <div>
          ...
          <div>
            {report?.volProgrammeBySector?.secondMonth?.map((report: any) => {
              return (
                <div key={report?.label}>{report?.volArr?.length || 0}</div>
              );
            })}
          ...
          <div>
            {report?.volProgrammeBySector?.thirdMonth?.map((report: any) => {
              return (
                <div key={report?.label}>{report?.volArr?.length || 0}</div>
              );
            })}
            ...
            {report?.volProgrammeBySector?.firstMonth?.map(
              (volProgByTypes: any, index: number) => {
                return (
                  <div key={volProgByTypes?.label}>
                    {(volProgByTypes?.volArr?.length || 0) +
                      (report?.volProgrammeBySector?.secondMonth[index]?.volArr
                        ?.length || 0) +
                      (report?.volProgrammeBySector?.thirdMonth[index]?.volArr
                        ?.length || 0)}
                  </div>
                );
              }
            ...
            {report?.volGenders?.firstMonth?.map(
              (volProgByTypes: any, index: number) => {
                return (
                  <div key={volProgByTypes?.label}>
                    {(volProgByTypes?.volArr?.length || 0) +
                      (report?.volGenders?.secondMonth[index]?.volArr?.length ||
                        0) +
                      (report?.volGenders?.thirdMonth[index]?.volArr?.length ||
                        0)}
                  </div>
                );
              }
            ...
            {report?.volRace?.firstMonth?.map(
              (volProgByTypes: any, index: number) => {
                return (
                  <div key={volProgByTypes?.label}>
                    {(volProgByTypes?.volArr?.length || 0) +
                      (report?.volRace?.secondMonth[index]?.volArr?.length ||
                        0) +
                      (report?.volRace?.thirdMonth[index]?.volArr?.length || 0)}
                  </div>
                );
        ...
        <h3>
          #9 More diverse volunteering opportunities are offered by Activity and
          Region, First Month
        </h3>
        <div className="table-4">
        ...
        <div className="table-4">
          ...
          <div className="column-title">First Month</div>
          {report?.actRegionsVolBens?.firstMonth &&
            returnActRegionsVolBens(report?.actRegionsVolBens?.firstMonth)?.map(
              (element: any, index: number) => {
                return (
                  <div key={index}>
                    {Array.isArray(element)
        ...
        <div className="table-4">
          ...
          <div className="column-title">Second Month</div>
          {report?.actRegionsVolBens?.thirdMonth &&
            returnActRegionsVolBens(report?.actRegionsVolBens?.thirdMonth)?.map(
              (element: any, index: number) => {
                return (
                  <div key={index}>
                    {Array.isArray(element)
        ...
        <h3>#14 Volunteer involving organisation measure impact First Month</h3>
        ...
        <h3>#14 Volunteer involving organisation measure impact Third Month</h3>
        <div className="table-3">
          <div className="column-title">Country</div>
          <div className="column-title">Region</div>
          <div className="column-title">Nº volunteer</div>
        ...
        <h3>#15 Volunteer involving organisation secure funding First Month</h3>
        <div className="table-4">
          <div className="column-title">Country</div>
          <div className="column-title">Region</div>
        ...
        <h3>#15 Volunteer involving organisation secure funding Third Month</h3>
        <div className="table-4">
          <div className="column-title">Country</div>
          <div className="column-title">Region</div>
          <div className="column-title">Funding Categories</div>
        ...
        <h3>#16 Volunteer involvement offers net economic gain First Month</h3>
        ...
        <h3>#16 Volunteer involvement offers net economic gain Second Month</h3>
        <div className="table-2">
          <div className="column-title">Organisation</div>
          <div className="column-title">Third Month</div>
          <div>
        ...
        <h3>#16 Volunteer involvement offers net economic gain Third Month</h3>
        <div className="table-2">
          <div className="column-title">Organisation</div>
          <div className="column-title">Third Month</div>
          <div>
        ...
        <h3>
          #18 Health services have employer supported volunteering programmes
          First Month
        </h3>
        <div className="table-3">
          <div className="column-title">Country</div>
        ...
        <h3>#19 Educational institutions involve volunteers Second Month</h3>
        <div className="table-3">
          <div className="column-title">Country</div>
          <div className="column-title">Region</div>
          <div className="column-title">Sector</div>
        ...
        <PieChartGapComponent data={environmentProgTypes.sort(orderByName)} />
        ...
        <PieChartGapComponent data={environmentProgSector.sort(orderByName)} />
        ...
        <div className="table-5">
          ...
          <div>{report?.descRecMatMons?.firstMonth?.totalActRecEq || 0}</div>
          <div>{report?.descRecMatMons?.secondMonth?.totalActRecEq || 0}</div>
          <div>{report?.descRecMatMons?.thirdMonth?.totalActRecEq || 0}</div>
          <div>
            {(report?.descRecMatMons?.firstMonth?.totalActRecEq || 0) +
              (report?.descRecMatMons?.secondMonth?.totalActRecEq || 0) +
              (report?.descRecMatMons?.thirdMonth?.totalActRecEq || 0)}
          ...
          <div>{report?.descRecMatMons?.firstMonth?.totalActRecCons || 0}</div>
          <div>{report?.descRecMatMons?.secondMonth?.totalActRecCons || 0}</div>
          <div>{report?.descRecMatMons?.thirdMonth?.totalActRecCons || 0}</div>
          <div>
            {(report?.descRecMatMons?.firstMonth?.totalActRecCons || 0) +
              (report?.descRecMatMons?.secondMonth?.totalActRecCons || 0) +
              (report?.descRecMatMons?.thirdMonth?.totalActRecCons || 0)}
...
export const getServerSideProps: any = async (context: any) => {
  const { year, quartil } = context.query;
